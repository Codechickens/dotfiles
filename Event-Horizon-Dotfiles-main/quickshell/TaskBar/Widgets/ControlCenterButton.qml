    ...
    MouseArea {
        ...
        onPressed: {
            if (popupTarget && popupTarget.setTriggerPosition) {
                ...
                // Use "center" as triggerSection like dock does for control center
                ...
                console.log(`[TaskBar ControlCenterButton] Setting bar properties: position="${barPos}", thickness=${barHeight}, margin=${bottomMargin}, effective=${effectiveBarHeight}`);
                popupTarget.barPosition = barPos;
                popupTarget.barThickness = effectiveBarHeight;
                console.log(`[TaskBar ControlCenterButton] Calling setTriggerPosition: (${triggerX}, ${triggerY}), width=${rect.width}, section="center"`);
