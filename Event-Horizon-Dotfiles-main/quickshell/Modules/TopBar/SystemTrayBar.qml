...
Item {
    ...
    readonly property real scaleFactor: widgetHeight / 30
    readonly property int calculatedSize: visibleTrayItems.length > 0 ? visibleTrayItems.length * (24 * scaleFactor) + horizontalPadding * 2 : 0
