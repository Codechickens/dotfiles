...
PanelWindow {
    ...
    WlrLayershell.anchors: {
        ...
        if (!pos || typeof pos !== "string") return WlrLayershell.AnchorTop;
        return pos === "bottom" ? WlrLayershell.AnchorBottom :
               pos === "left" ? WlrLayershell.AnchorLeft :
               pos === "right" ? WlrLayershell.AnchorRight :
    ...
    screen: modelData
    color: "transparent"
    implicitWidth: barIsVertical ? Math.max(32, Number((effectiveBarHeight || 32) + (SettingsData?.topBarSpacing || 0) + ((SettingsData?.topBarGothCornersEnabled && (_wingR || 0)) ? (_wingR || 0) : 0)) || 32) : 0
                    ...
                    readonly property int availableHeight: barIsVertical ? width : height
                        ...
                        Item {
                            ...
                            function positionWidgets(configuredWidgets) {
                                ...
                                const globalCenter = parent.width / 2
                                const parentCenterX = globalCenter - x
