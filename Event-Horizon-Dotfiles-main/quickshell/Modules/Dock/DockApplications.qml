...
Rectangle {
    ...
    Item {
        ...
        width: SettingsData.launcherLogoSize > 0 ? (SettingsData.launcherLogoSize - 6) * (root.widgetHeight / 40) : Math.min(Theme.iconSize, root.widgetHeight - 8)
        height: SettingsData.launcherLogoSize > 0 ? (SettingsData.launcherLogoSize - 6) * (root.widgetHeight / 40) : Math.min(Theme.iconSize, root.widgetHeight - 8)
