                ...
                Column {
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            StyledText {
                                text: "Configure dock clock appearance and format"
                                font.pixelSize: Theme.fontSizeSmall
                                color: Theme.surfaceVariantText
                            }
                        }
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Show Full Date"
                        description: "Display the complete date above the time"
                        checked: SettingsData.dockClockShowFullDate
                        onToggled: checked => {
                            SettingsData.dockClockShowFullDate = checked
                        }
                    }
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Show Seconds"
                        description: "Include seconds in the time display"
                        checked: SettingsData.dockClockShowSeconds
                        onToggled: checked => {
                            SettingsData.dockClockShowSeconds = checked
                        }
                    }
                    ...
                    EHToggle {
                        ...
                        description: "Display time in 12-hour format with AM/PM"
                        checked: SettingsData.dockClockUse12Hour
                        onToggled: checked => {
                            SettingsData.dockClockUse12Hour = checked
                        }
                    }
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Show AM/PM"
                        description: "Display AM/PM indicators when using 12-hour format"
                        checked: SettingsData.dockClockShowAmPm
                        onToggled: checked => {
                            SettingsData.dockClockShowAmPm = checked
                        }
                    }
                    ...
                    EHSlider {
                        ...
                        onSliderValueChanged: newValue => {
                            SettingsData.dockClockFontSize = newValue / 10.0
                        }
                    }
                }
            }
