...
Item {
    ...
    // Check if widget needs dock/bar awareness (all desktop widgets)
    readonly property bool needsDockBarAwareness: isBuiltin || (typeof PluginService !== 'undefined' && PluginService.pluginDesktopComponents?.[pluginId] !== undefined)
