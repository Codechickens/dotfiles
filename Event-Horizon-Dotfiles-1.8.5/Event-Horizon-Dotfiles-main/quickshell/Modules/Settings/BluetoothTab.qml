                                ...
                                RowLayout {
                                    ...
                                    Row {
                                        ...
                                        Rectangle {
                                            ...
                                            height: 32
                                            radius: 16
                                            color: connectButtonMouseArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.15) : "transparent"
                                        ...
                                        Rectangle {
                                            ...
                                            height: 32
                                            radius: 16
                                            color: forgetButtonMouseArea.containsMouse ? Qt.rgba(Theme.error.r, Theme.error.g, Theme.error.b, 0.15) : "transparent"
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                radius: Theme.cornerRadius
                                color: availableDeviceMouseArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.08) : Qt.rgba(Theme.surfaceVariant.r, Theme.surfaceVariant.g, Theme.surfaceVariant.b, index % 2 === 0 ? 0.3 : 0.2)
                                border.color: Qt.rgba(Theme.outline.r, Theme.outline.g, Theme.outline.b, 0.2)
                                border.width: 1
                                ...
                                RowLayout {
                                    ...
                                    Rectangle {
                                        ...
                                        height: 32
                                        radius: 16
                                        color: pairButtonMouseArea.containsMouse ? Qt.rgba(Theme.primary.r, Theme.primary.g, Theme.primary.b, 0.15) : "transparent"
