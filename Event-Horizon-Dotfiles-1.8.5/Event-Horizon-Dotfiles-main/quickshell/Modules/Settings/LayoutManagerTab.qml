...
Item {
    ...
    function loadSavedLayouts() {
        ...
        try {
            ...
            // Only check for super_dock.json - the user must explicitly add other layouts
            // This avoids warnings about missing files that the user doesn't have
            var knownLayoutFiles = [
                "super_dock.json"
            ]
            
            // Try to load each known file using FileView
            knownLayoutFiles.forEach(function(fileName) {
