...
main() {
    ...
    cp ./quickshell/quickshell.service ~/.config/systemd/user/
    systemctl --user enable --now quickshell.service
    print_success "Quickshell systemd service enabled"
    ...
    echo -e "  ${CHECKMARK} Quickshell systemd service enabled"
