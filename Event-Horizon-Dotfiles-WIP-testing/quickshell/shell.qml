...
ShellRoot {
    ...
    LazyLoader {
        ...
        WorkspaceOverviewWidget {
            ...
            onOverviewClicked: function() {
                workspaceOverviewLoader.active = false
            }
        }
    }
    ...
    IpcHandler {
        function open(): string {
            ...
            return "WORKSPACE_OVERVIEW_OPEN_SUCCESS"
        }

        function close(): string {
            workspaceOverviewLoader.active = false
            return "WORKSPACE_OVERVIEW_CLOSE_SUCCESS"
        }

        function toggle(): string {
            workspaceOverviewLoader.active = !workspaceOverviewLoader.active
    ...
    IpcHandler {
        function open(tab: string): string {
            ...
            if (darkDashLoader.item) {
                ...
                darkDashLoader.item.setTriggerPosition(Screen.width / 2, SettingsData.topBarHeight + SettingsData.topBarSpacing + Theme.spacingS, 100, "center", Screen)
