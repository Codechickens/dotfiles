            ...
            StyledRect {
                ...
                Column {
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Auto-fit Width"
                        description: "Automatically resize the top bar to fit the combined width of all widgets, eliminating unused horizontal space"
                        checked: SettingsData.topBarAutoFit
                        onToggled: toggled => {
                                       return SettingsData.setTopBarAutoFit(
                                           toggled)
                                   }
                    }
                    ...
                    EHToggle {
                        width: parent.width
                        text: "Auto-fit Rounded Corners"
                        description: "Add rounded corners to the top bar when in auto-fit width mode"
                        checked: SettingsData.topBarAutoFitRoundedCorners
                        visible: SettingsData.topBarAutoFit
                        onToggled: toggled => {
                                       return SettingsData.setTopBarAutoFitRoundedCorners(
                                           toggled)
                                   }
                    }
                    ...
                    Column {
                        ...
                        visible: SettingsData.topBarAutoFit && SettingsData.topBarAutoFitRoundedCorners

                        StyledText {
                            text: "Auto-fit Corner Radius"
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: SettingsData.topBarAutoFitCornerRadius
                            minimum: 0
                            maximum: 32
                            unit: "px"
                            showValue: true
                            ...
                            onSliderValueChanged: newValue => {
                                                        SettingsData.setTopBarAutoFitCornerRadius(
                                                            newValue)
                                                    }
                        }
                    }
                ...
                Column {
                    ...
                    Column {
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: Math.round(SettingsData.topBarBorderRadius)
                            minimum: 0
                            maximum: 50
                            unit: "px"
                            showValue: true
                ...
                Column {
                    ...
                    Column {
                        ...
                        EHSlider {
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setTopbarScale(newValue / 100)
                                                  }
                        }
                    }
