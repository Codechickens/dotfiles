...
Item {
    ...
    EHFlickable {
        ...
        Column {
            ...
            StyledRect {
                Layout.fillWidth: true
                Layout.preferredHeight: audioSettingsColumn.implicitHeight + Theme.spacingL * 2
                radius: Theme.cornerRadius
                color: Qt.rgba(Theme.surfaceVariant.r, Theme.surfaceVariant.g, Theme.surfaceVariant.b, Theme.getContentBackgroundAlpha() * 0.3)
                border.color: Qt.rgba(Theme.outline.r, Theme.outline.g, Theme.outline.b, 0.12)
                border.width: 1
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            text: "Allow volumes above 100% (up to 150%)"
                            font.pixelSize: Theme.fontSizeSmall
                        ...
                        EHToggle {
                            ...
                            onCheckedChanged: {
                                SettingsData.audioVolumeOverdrive = checked
                            }
                        }
                    }
                }
