        ...
        Column {
            ...
            StyledRect {
                ...
                Column {
                    ...
                    Row {
                        ...
                        Row {
                            ...
                            EHActionButton {
                                ...
                                iconSize: 18
                                onClicked: {
                                    SettingsData.setAppDrawerScale(SettingsData.appDrawerScale + 0.1)
                                }
                            }
                    ...
                    StyledText {
                        text: "Adjust the size of the app drawer popup (currently: " + Math.round(SettingsData.appDrawerScale * 100) + "%)"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceVariantText
                        wrapMode: Text.WordWrap
                        width: parent.width
                    ...
                    EHSlider {
                        ...
                        wheelEnabled: false
                        onSliderValueChanged: newValue => {
                                                    SettingsData.setAppDrawerScale(newValue / 100)
                                                }
                    }
                }
            }
