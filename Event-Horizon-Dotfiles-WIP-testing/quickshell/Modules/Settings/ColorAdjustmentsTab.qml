    ...
    EHFlickable {
        ...
        Column {
            ...
            StyledRect {
                ...
                color: Qt.rgba(
                    Theme.surfaceContainerHigh ? Theme.surfaceContainerHigh.r : 0.1,
                    Theme.surfaceContainerHigh ? Theme.surfaceContainerHigh.g : 0.1,
                    Theme.surfaceContainerHigh ? Theme.surfaceContainerHigh.b : 0.1,
                    0.4)
