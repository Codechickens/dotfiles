...
Item {
    ...
    property string barPosition: "top"  // "top", "bottom", "left", "right" - physical position of the bar
    property string menuSection: "right"  // "left", "right" - horizontal alignment for horizontal bars
    property real barThickness: 48
    property real popupDistance: 8

    // Anchor item for positioning (like TopBarTrayContextMenu)
    property var anchorItem: null
    property real anchorWidth: 0
    property var autoFitWidth: null
    ...
    function setTriggerPosition(x, y, width, section, screen) {
        // Store anchor info for positioning
        _anchorX = x
        _anchorY = y
        anchorWidth = width
        parentScreen = screen
        // section is the horizontal alignment (left/right) for horizontal bars
        // barPosition should already be set correctly before this is called
        menuSection = section || "right"

        // If screen was passed, set it on the window
    ...
    PanelWindow {
        ...
        function updatePosition() {
            ...
            if (root.barPosition === "top") {
                ...
                const iconCenterX = root._anchorX
                targetX = iconCenterX
                ...
                const iconCenterY = root._anchorY
