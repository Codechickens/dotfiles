...
EHPopout {
    ...
    readonly property bool barVisible: typeof SettingsData !== "undefined" ? SettingsData.minipanelVisible : true
    ...
    readonly property real barThickness: (typeof SettingsData !== "undefined" && barVisible && !barFloating) ? 
        (SettingsData.minipanelHeight + SettingsData.minipanelSpacing + (SettingsData.minipanelGothCornersEnabled ? Theme.cornerRadius : 0)) : 0
