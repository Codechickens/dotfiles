...
Rectangle {
    ...
    MouseArea {
        ...
        onPressed: {
            ...
            if (popup && popup.shouldBeVisible) {
                ...
                if (isBarVertical && SettingsData.minipanelPosition === "right") {
    ...
    barPosition: SettingsData?.minipanelPosition || "top"
    barThickness: {
        const barPos = SettingsData?.minipanelPosition || "top"
        const barHeight = (SettingsData?.minipanelHeight || 32) * (SettingsData?.minipanelScale || 1)
        const margin = (barPos === "bottom" && barPos !== "left" && barPos !== "right") ? (SettingsData?.minipanelTopMargin || 0) : 0
