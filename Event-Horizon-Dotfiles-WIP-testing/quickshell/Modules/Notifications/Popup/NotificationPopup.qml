...
PanelWindow {
    ...
    margins {
        top: (SettingsData.topBarHeight * SettingsData.topbarScale) - 4 + SettingsData.topBarSpacing + 4
        right: 12
    }
                ...
                EHCircularImage {
                    ...
                    imageSource: {
                        ...
                        if (hasNotificationImage)
                            return win.resolveArtUrl(notificationData.cleanImage) || notificationData.cleanImage || ""
