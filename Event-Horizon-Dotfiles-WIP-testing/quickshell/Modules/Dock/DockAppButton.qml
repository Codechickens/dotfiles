...
Item {
    ...
    MouseArea {
        ...
        onPositionChanged: mouse => {
                               ...
                               const spacing = Math.min(8, Math.max(4, SettingsData.dockIconSize * SettingsData.dockScale * 0.08))
                               const itemSize = SettingsData.dockIconSize * SettingsData.dockScale * 1.2 + spacing
    ...
    Item {
        ...
        Image {
            ...
            width: SettingsData.dockIconSize * SettingsData.dockScale
            height: SettingsData.dockIconSize * SettingsData.dockScale
            sourceSize.width: SettingsData.dockIconSize * SettingsData.dockScale
            sourceSize.height: SettingsData.dockIconSize * SettingsData.dockScale
        ...
        EHIcon {
            anchors.centerIn: parent
        size: SettingsData.dockIconSize * SettingsData.dockScale
        name: "sports_esports"
