...
Item {
    ...
    property real iconSize: SettingsData.dockIconSize * SettingsData.dockScale
    property real iconSpacing: SettingsData.dockIconSpacing * SettingsData.dockScale
    ...
    ListView {
        ...
        delegate: Item {
                ...
                width: model.type === "separator" ? 16 * SettingsData.dockScale : SettingsData.dockIconSize * SettingsData.dockScale
                height: SettingsData.dockIconSize * SettingsData.dockScale
                ...
                property real shiftOffset: {
                    ...
                    const shiftAmount = SettingsData.dockIconSize * 1.2 * SettingsData.dockScale + spacing
