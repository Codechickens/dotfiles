...
Column {
                ...
                Repeater {
                    ...
                    Item {
                        ...
                        height: {
                            ...
                            if (id === "volumeSlider") return 48
                            if (id === "inputVolumeSlider") return 40
                ...
                Row {
                    ...
                    StyledText {
                        text: {
                            ...
                            case "audioOutput": {
                                const desc = AudioService.sink?.description || "No output"
                                return desc.length > 25 ? desc.substring(0, 25) + "..." : desc
                            }
                            case "audioInput": {
                                const desc = AudioService.source?.description || "No input"
                                return desc.length > 25 ? desc.substring(0, 25) + "..." : desc
                            }
                            case "volumeMixer": {
                                return "Volume Mixer"
    ...
    Component {
        ...
        Rectangle {
            ...
            property int widgetIndex: parent.widgetIndex || 0
            width: parent.width
            height: brightnessSliderRow.implicitHeight + Theme.spacingS * 2
            radius: Theme.cornerRadius
