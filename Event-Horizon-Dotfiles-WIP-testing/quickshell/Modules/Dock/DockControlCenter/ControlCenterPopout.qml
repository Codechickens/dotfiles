    ...
    PanelWindow {
        ...
        function updatePosition() {
            ...
            if (root.barPosition === "top") {
                targetX = (root.triggerWidth > 0) ? (root.triggerX + root.triggerWidth / 2) : (screenX + screen.width / 2)
                ...
                targetY = (root.triggerWidth > 0) ? (root.triggerY + root.triggerWidth / 2) : (screenY + screen.height / 2)
        ...
        Rectangle {
            id: menuContainer
            width: Math.min(700, Math.max(500, menuColumn.implicitWidth + Theme.spacingS * 2))
            height: menuColumn.childrenRect.height + Theme.spacingS * 2
            ...
            transformOrigin: root.barPosition === "top" ? Item.TopRight : (root.barPosition === "left" ? Item.BottomLeft : Item.BottomRight)
            transform: Translate {
                x: root.showMenu ? 0 : 200
                y: root.showMenu ? 0 : (root.barPosition === "top" ? -20 : 20)
                Behavior on x {
                    NumberAnimation {
                        duration: Theme.mediumDuration
                        easing.type: Easing.OutCubic
