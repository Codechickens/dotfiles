...
Singleton {
    ...
    function loadSettings() {
        ...
        if (controlCenterWidgets && controlCenterWidgets.filter) {
            controlCenterWidgets = controlCenterWidgets.filter(w => w.id !== "volumeSlider" && w.id !== "inputVolumeSlider")
        }
    ...
    function parseSettings(content) {
        ...
        desktopGpuSelection = settings.desktopGpuSelection !== undefined ? settings.desktopGpuSelection : "auto"
                ...
                if (settings.dockLeftWidgets === undefined && settings.dockCenterWidgets === undefined && settings.dockRightWidgets === undefined) {
