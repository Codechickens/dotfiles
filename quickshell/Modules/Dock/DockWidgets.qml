...
Row {
    ...
    // Unified scaling properties that combine widget height with global scale
    readonly property real unifiedScaleFactor: (root.widgetHeight / 40) * SettingsData.dockWidgetScale
    readonly property real unifiedIconSize: SettingsData.dockWidgetIconSize * unifiedScaleFactor
    readonly property real unifiedFontSize: SettingsData.dockWidgetFontSize * unifiedScaleFactor
    readonly property real unifiedIconSpacing: SettingsData.dockWidgetIconSpacing * unifiedScaleFactor
    readonly property real unifiedPadding: SettingsData.dockWidgetPadding * unifiedScaleFactor
    ...
    Component { 
        ...
        Rectangle {
            width: launcherIcon.width + 16 * (root.widgetHeight / 40)
            height: root.widgetHeight
            radius: Theme.cornerRadius * (root.widgetHeight / 40)
            ...
            SystemLogo {
                ...
                width: Math.max(1, SettingsData.launcherLogoSize * (root.widgetHeight / 40))
                height: Math.max(1, SettingsData.launcherLogoSize * (root.widgetHeight / 40))
            ...
            EHIcon {
                ...
                anchors.centerIn: parent
                name: "apps"
                size: Math.max(1, SettingsData.launcherLogoSize * (root.widgetHeight / 40))
    ...
    Component { 
        ...
        Rectangle {
            width: clipboardIcon.width + 2 * root.unifiedPadding
            height: root.widgetHeight
            radius: Theme.cornerRadius * root.unifiedScaleFactor
            color: {
