                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea {
                                            ...
                                            cursorShape: Qt.PointingHandCursor
                                            onClicked: {
                                                wallpaperTab.setDefaultWallpaper()
                                            }
                                        }
                                    }
                                }
            ...
            StyledRect {
                ...
                Row {
                    ...
                    StyledRect {
                        ...
                        // X button overlay for current wallpaper banner
                        Rectangle {
                            id: bannerClearButton
                            ...
                            height: 36
                            radius: Theme.cornerRadius
                            color: Qt.rgba(0, 0, 0, bannerHoverArea.containsMouse ? 0.8 : 0.6)
                            border.color: Qt.rgba(255, 255, 255, 0.3)
                            border.width: 1
                            opacity: bannerHoverArea.containsMouse ? 1.0 : 0.7
                        ...
                        GridView {
                            ...
                            delegate: Item {
                                ...
                                StyledRect {
                                    ...
                                    // X button overlay for selected wallpaper - only shows on hover
                                    Rectangle {
                                        id: clearWallpaperOverlay
                                        anchors.top: parent.top
                                        anchors.right: parent.right
                                        anchors.margins: 8
                                        width: 36
                                        height: 36
                                        radius: Theme.cornerRadius
                                        color: Qt.rgba(0, 0, 0, thumbnailMouseArea.containsMouse ? 0.8 : 0.6)
                                        border.color: Qt.rgba(255, 255, 255, 0.3)
                                        border.width: 1
                                        visible: isSelected && thumbnailMouseArea.containsMouse
                                        opacity: thumbnailMouseArea.containsMouse ? 1.0 : 0
