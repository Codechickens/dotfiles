...
Item {
    ...
    EHFlickable {
        ...
        Column {
            ...
            Column {
                ...
                StyledRect {
                    ...
                    WidgetsTabSection {
                        ...
                        onItemOrderChanged: newOrder => {
                                                dockTab.handleItemOrderChanged("dockCenter", newOrder)
                                            }
                        onAddWidget: sectionId => {
                                         widgetSelectionPopup.allWidgets = dockTab.dockWidgetDefinitions
                                         widgetSelectionPopup.targetSection = sectionId
                ...
                Column {
                    ...
                    Column {
                        ...
                        EHSlider {
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockScale(newValue / 100)
                                                  }
                        }
                    }
            ...
            StyledRect {
                width: Math.min(parent.width * 1.2, parent.parent ? parent.parent.width - 48 : parent.width * 1.2)
                height: widgetScaleSection.implicitHeight + Theme.spacingL * 2
                anchors.horizontalCenter: parent.horizontalCenter
                radius: Theme.cornerRadius
                color: Qt.rgba(Theme.surfaceVariant.r, Theme.surfaceVariant.g,
                               Theme.surfaceVariant.b, 0.3)
                border.color: Qt.rgba(Theme.outline.r, Theme.outline.g,
                                      Theme.outline.b, 0.2)
                border.width: 1
                visible: SettingsData.showDock && SettingsData.dockWidgetsEnabled
                opacity: visible ? 1 : 0

                Column {
                    id: widgetScaleSection
                    ...
                    StyledText {
                        width: parent.width
                        text: "Uniformly scale all dock widgets including icons and text"
                        font.pixelSize: Theme.fontSizeSmall
                        color: Theme.surfaceVariantText
                    ...
                    Column {
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: Math.round(SettingsData.dockWidgetScale * 100)
                            minimum: 50
                            maximum: 200
                            unit: "%"
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockWidgetScale(newValue / 100)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Font Size: " + SettingsData.dockWidgetFontSize.toFixed(1) + "px"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceText
                            font.weight: Font.Medium
                        }
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: SettingsData.dockWidgetFontSize
                            minimum: 8
                            maximum: 24
                            unit: "px"
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockWidgetFontSize(newValue)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Icon Size: " + SettingsData.dockWidgetIconSize.toFixed(1) + "px"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceText
                            font.weight: Font.Medium
                        }
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: SettingsData.dockWidgetIconSize
                            minimum: 12
                            maximum: 36
                            unit: "px"
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockWidgetIconSize(newValue)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Icon Spacing: " + SettingsData.dockWidgetIconSpacing.toFixed(1) + "px"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceText
                            font.weight: Font.Medium
                        }
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: SettingsData.dockWidgetIconSpacing
                            minimum: 2
                            maximum: 16
                            unit: "px"
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockWidgetIconSpacing(newValue)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        StyledText {
                            text: "Widget Padding: " + SettingsData.dockWidgetPadding.toFixed(1) + "px"
                            font.pixelSize: Theme.fontSizeSmall
                            color: Theme.surfaceText
                            font.weight: Font.Medium
                        }
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: SettingsData.dockWidgetPadding
                            minimum: 4
                            maximum: 20
                            unit: "px"
                            showValue: true
                            ...
                            thumbOutlineColor: Theme.surfaceContainer
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockWidgetPadding(newValue)
                                                  }
                        }
                    }
                }
            ...
            StyledRect {
                width: Math.min(parent.width * 1.2, parent.parent ? parent.parent.width - 48 : parent.width * 1.2)
                height: pinnedAppsIconSection.implicitHeight + Theme.spacingL * 2
                anchors.horizontalCenter: parent.horizontalCenter
                radius: Theme.cornerRadius
                color: Qt.rgba(Theme.surfaceVariant.r, Theme.surfaceVariant.g,
                               Theme.surfaceVariant.b, 0.3)
                ...
                Column {
                    ...
                    Row {
                        ...
                        StyledText {
                            text: "Pinned Apps Icon Size/Spacing"
                            font.pixelSize: Theme.fontSizeLarge
                            font.weight: Font.Medium
                            color: Theme.surfaceText
                            anchors.verticalCenter: parent.verticalCenter
                    ...
                    Column {
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: Math.round(SettingsData.dockPinnedAppsIconSize)
                            minimum: 16
                            maximum: 96
                            unit: "px"
                            showValue: true
                            wheelEnabled: false
                            onSliderValueChanged: newValue => {
                                                      SettingsData.setDockPinnedAppsIconSize(newValue)
                                                  }
                        }
                    }
                    ...
                    Column {
                        ...
                        EHSlider {
                            width: parent.width
                            height: 24
                            value: Math.round(SettingsData.dockPinnedAppsIconSpacing)
                            minimum: 0
                            maximum: 32
                            unit: "px"
                            showValue: true
